  ...
  return (
    <main className="min-h-screen">
      <header className="sticky top-0 z-30 bg-white/95 backdrop-blur-md border-b border-stone-200/80">
        {/* 顶部一行：平台 tab + 我的发布 + 发布按钮 */}
        <div className="max-w-6xl mx-auto px-3 md:px-4 pt-3 pb-2 flex items-center gap-3">
          <PlatformTabs />
        ...
        {/* 子标题（描述这个平台是干嘛的，方便新用户秒懂） */}
        <div className="max-w-6xl mx-auto px-4 pb-2">
          <h1 className="text-base font-semibold text-stone-900 tracking-tight">
            黑堡<span className="text-brand">室友&转租</span>
          </h1>
          <p className="text-xs text-stone-500 mt-0.5">
            找室友 · 找合租伙伴 · 转租 · 暑期短租 —— 双向同意后才看对方联系方式
          </p>
        </div>
      </header>
