...
export const messages = {
  ...
  'poster.hintCopy':       { zh: '点「复制图片」，去微信群里直接粘贴；群友扫码就能看到你的全部在售', en: 'Tap Copy image, then paste it into WeChat. The QR code opens all your listings.' },
  'poster.copy':           { zh: '复制图片',                                    en: 'Copy image' },
  'poster.copyN':          { zh: '复制第 {page} 张',                            en: 'Copy #{page}' },
  'poster.copied':         { zh: '已复制',                                      en: 'Copied' },
  'poster.copiedGo':       { zh: '已复制 · 去微信粘贴',                          en: 'Copied. Paste it in WeChat' },
  'poster.copyFailed':     { zh: '这个浏览器不让复制图片，长按图片保存，或用下载',    en: "This browser blocked image copy. Long-press to save, or download." },
  ...
  'search.chatTitle':      { zh: 'AI 助手',                                    en: 'AI assistant' },
  'search.chatClose':      { zh: '关闭对话',                                   en: 'Close' },
  'search.askButton':      { zh: '问 AI',                                      en: 'Ask AI' },
  'search.askHint':        { zh: '没找到？让 AI 帮你找',                         en: "Didn't find it? Ask AI" },
  'header.searchAsk':      { zh: '搜索，或提问',                           en: 'Search, or just ask' },
  'feedback.title':        { zh: '转给站长',                                   en: 'Send to the site admin' },
  'feedback.link':         { zh: '遇到问题？告诉站长',                           en: 'Something wrong? Tell the admin' },
  'feedback.messagePlaceholder': { zh: '写下你遇到的问题或想问的事',              en: 'Describe the problem or your question' },
  'feedback.contactPlaceholder': { zh: '怎么回复你（选填：微信 / 邮箱）',          en: 'How to reach you (optional: WeChat / email)' },
  'feedback.note':         { zh: '站长本人会看到这条消息',                        en: 'The site admin reads these personally' },
  'feedback.send':         { zh: '发送',                                       en: 'Send' },
  'feedback.sending':      { zh: '发送中…',                                    en: 'Sending…' },
  'feedback.sent':         { zh: '已发给站长，谢谢',                             en: 'Sent. Thank you.' },
  'feedback.sentWithContact': { zh: '已发给站长，会按你留的方式回复',              en: "Sent. We'll reply via the contact you left." },
  'feedback.error':        { zh: '没发出去，再试一次',                           en: "Couldn't send. Try again." },
